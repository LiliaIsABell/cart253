...
class Predator {
  ...
  constructor(x, y, fillColor, radius, upKey, downKey, leftKey, rightKey,
    preyEaten, scoreX, scoreY, sprintKey) {
    // Position
    this.x = x;
    this.y = y;
    // Velocity and speed
    this.vx = 0;
    this.vy = 0;
    // Added a value to the speed instead of
    // adding it in script
    this.speed = 5;
    // Health properties
    ...
    // Input properties
    // Since they are now arguments, I do not write the keys here
    this.upKey = upKey;
